...
CREATE DATABASE [ProjetChantier]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'ProjetChantier', FILENAME = N'C:\Users\Nelson\Dropbox\PC\Desktop\DEVELOPPEMENT-APPLICATIOS\projetChantier\NelsonCuervo\ProjetChantier.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'ProjetChantier_log', FILENAME = N'C:\Users\Nelson\Dropbox\PC\Desktop\DEVELOPPEMENT-APPLICATIOS\projetChantier\NelsonCuervo\ProjetChantier_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
